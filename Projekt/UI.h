...
public:
	...
	void DrawCharacterStatsInGame(characterStats playerStats, float x_pos, float starting_y_pos, float fontSize, map<string,float>& statsChange, bool drawChanges);//GAME: Wyświetla aktualne statystyki gracza w trakcie gry
