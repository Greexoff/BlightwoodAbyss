...
void RulesMenu::setPagesContent()
{
	...
	ItemsInfoPages =
	{
		...
		{"COLLECTIBLE ITEMS","TEAR RATE TRINKET",{"REDUCES TIME BETWEEN SHOTS BY 0.04 (MIN IS 0.12)","GAP","HOW TO UNLOCK:", "DEFEAT FIRST WAVE WITHIN 10 SECONDS"}, "TearRateTrinket.png"},
